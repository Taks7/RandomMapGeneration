...
{
	// L02:  1: This is a good place to call Load / Save methods
}
...
// L02:  5: Create a method to actually load an xml file
// then call all the modules to load themselves

// L02:  7: Implement the xml save method for current state
