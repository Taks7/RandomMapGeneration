...
Once we got the previous part, we need to set the noise to be between 1 and 0, so the next step we have to do is to apply the formula given by the author of the library, (Noise + 1) *0.5 :
